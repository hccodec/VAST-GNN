...
parser.add_argument("-y", "--ydays", choices=['3', '7', '14'], default=3, help="预测未来第几天")
...
else: raise KeyError('参数有误')

res, meta_data, args = test(f"/home/hbj/workspace/vscode_workspace/lp/workspace/checkpoints/{args.dataset}_o{args.node_observed_ratio}_y{args.ydays}_{args.country}_{args.model}.pth", logger_disable=True)
