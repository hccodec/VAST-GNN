...
class SingletonLogger:
    ...
    def set_logger(self, log_file_path):
        ...
        if log_file_path is None: return
        # 处理文件日志
    ...
    def getLogger(self, type=''):
        ...
        if type == '': return self.logger
        elif type == 'console': return self.console_logger
        elif type == 'file': return self.file_logger

_logger = SingletonLogger()

def set_logger(log_file_path): _logger.set_logger(log_file_path)
